...
<head runat="server">
<title>BooksMahal | Track Your Order </title>
	...
	<style>
		#signinbtn, #signoutbtn, #informer, #showbtn, #enoid, #placedbox, #trackbox, #showdiv, #canceledbox, #deliveredbox {
			display: none;
		}
		.addtocart {
			margin-top: 10px;
...
<body>
	<form id="form1" runat="server">
		...
		<div style="min-height:80vh;padding:50px 0px;background:url('images/bm1.jpg') center no-repeat;">
			<div id="enoid" class="col-sm-4" style="margin-left:50vw;transform:translateX(-50%);">
				<div class="box-center text-center">
					<h4>Track Your Order</h4><hr />
					<asp:TextBox runat="server" ID="oidtxt" TextMode="Number" MaxLength="50" CssClass="form-control" placeholder="Enter Order ID" style="margin-bottom:10px;"></asp:TextBox>
					<asp:Button runat="server" ID="trackbtn" CssClass="btn btn-success" Text="Track Order" OnClick="trackbtn_Click" style="margin-top:15px;"/>
				</div>
			</div>
			<div id="trackbox" class="col-sm-4" style="margin-left:50vw;transform:translateX(-50%);">
				<div class="box-center text-center">
					<img src="images/orderontheway.gif" style="width:100%;"/><br /><br />
					<h4>Your Order is on the way. It will reached to you as soon as possible.</h4><br />
					<a href="Home" class="btn btn-info addtocart link">Go Home</a><br />
					<a href="Home" class="btn btn-info addtocart link">Continue to Shop</a><br />
					<a href="Track_Your_Order" class="btn btn-success addtocart link">Track Another Order</a>
				</div>
			</div>
			<div id="placedbox" class="col-sm-4" style="margin-left:50vw;transform:translateX(-50%);">
				<div class="box-center text-center">
					<br /><i class="fa fa-handshake" style="color:forestgreen;font-size:85px;border-radius:50%;padding:35px;border:0.5px solid green;"></i><br /><br />
					<h4>Your order is placed Successfully, Please wait until it will accepted.</h4><br />
					<a href="Home" class="btn btn-info addtocart link">Go Home</a><br />
					<a href="Home" class="btn btn-info addtocart link">Continue to Shop</a><br />
					<a href="Track_Your_Order" class="btn btn-success addtocart link">Track Another Order</a>
				</div>
			</div>
			<div id="deliveredbox" class="col-sm-4" style="margin-left:50vw;transform:translateX(-50%);">
				<div class="box-center text-center">
					<br /><i class="fa fa-home" style="color:forestgreen;font-size:85px;border-radius:50%;padding:35px;border:0.5px solid green;"></i><br /><br />
					<h4>Your order is Delevered Successfully.</h4><br />
					<a href="Home" class="btn btn-info addtocart link">Go Home</a><br />
					<a href="Home" class="btn btn-info addtocart link">Continue to Shop</a><br />
					<a href="Track_Your_Order" class="btn btn-success addtocart link">Track Another Order</a>
				</div>
			</div>
			<div id="canceledbox" class="col-sm-4" style="margin-left:50vw;transform:translateX(-50%);">
				<div class="box-center text-center">
					<br /><i class="fa fa-bomb" style="color:forestgreen;font-size:85px;border-radius:50%;padding:35px;border:0.5px solid green;"></i><br /><br />
					<h4>Your order is Canceled due to some reason. Please try again.</h4><br />
					<a href="Home" class="btn btn-info addtocart link">Go Home</a><br />
					<a href="Home" class="btn btn-info addtocart link">Continue to Shop</a><br />
					<a href="Track_Your_Order" class="btn btn-success addtocart link">Track Another Order</a>
				</div>
	...
	<script type="text/javascript">
		...
		else if ($("#informer").text() == "EnterCorrectOID") {
			$(".alert-box").show();
		}
		else if ($("#informer").text() == "CanNotBlack") {
			$(".alert-box").show();
		}


		if ($("#showdiv").text() == "NOTHING") {
			$("#enoid").show();
		}
		else if ($("#showdiv").text() == "NEW") {
			$("#placedbox").show();
		}
		else if ($("#showdiv").text() == "ACCEPTED") {
			$("#trackbox").show();
		}
		else if ($("#showdiv").text() == "DELIVERED") {
			$("#deliveredbox").show();
		}
		else if ($("#showdiv").text() == "REJECTED") {
			$("#canceledbox").show();
		}
