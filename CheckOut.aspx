...
<head runat="server">
    <title>BooksMahal | Checkout</title>
	...
	<style>
		#signinbtn, #signoutbtn, #informer, #showbtn, #showdiv, #label1, #label2, #label3, #label4, #label5 {
			display: none;
		}
		.btn-design {
			margin-top: 10px;
...
<body>
	...
	<!--checkout-->
		<div class="container" style="padding:15px;">
			<br /><h3 class="tittle-w3layouts">Checkout </h3><br />
			
			<h5 style="text-align:center;font-weight:bold;"><a href="Cart">Back to Cart</a></h5><hr style="width:60%;"/>
			<h4 style="text-align:center;font-weight:bold;">Continue to basket</h4><hr style="width:60%;"/>
			<div style="text-align:center;padding-top:10px;font-size:14px;overflow-y:auto;">
				<asp:PlaceHolder runat="server" ID="dquoteph"></asp:PlaceHolder>
				<table style="width:100%;">
					<tr><th>Sr. No.</th><th>Product Name</th><th>Category</th><th>Quantity</th><th>Total Price</th><th>Discount</th><th>Discount Price</th></tr>
					<asp:PlaceHolder runat="server" ID="pricelist"></asp:PlaceHolder>
					<tr><th colspan="6" style="font-size:16px;text-align:right;">Grand Total </th><th style="font-size:16px;"><asp:Label runat="server" ID="totcostlbl" Text="sdf"></asp:Label></th></tr>
				</table>
			</div><br /><br />
			
			<h4>Add or Update Details</h4><br />
			<label for="emailtxt">Email ID :</label>
			<asp:TextBox runat="server" ID="emailtxt" TextMode="Email" MaxLength="50" CssClass="form-control" placeholder="Enter Email ID" style="text-transform:lowercase;margin-bottom:10px;"></asp:TextBox>
			...
			<br /><asp:Button runat="server" ID="formbtn" CssClass="btn btn-success btn-design click-on" Text="Place this Order" OnClick="formbtn_Click" />
		</div><hr /><br />
	<!--//checkout-->
	<!--footer -->
	...
	<script type="text/javascript">
		...
		else if ($("#informer").text() == "CanNotDeliverInThisArea") {
			$(".alert-box").show();
		}
	...
	<script type="text/javascript">
		...
		var t2 = document.getElementById("mobiletxt");
		var t3 = document.getElementById("nametxt");
		var t4 = document.getElementById("addresstxt");
		var t5 = document.getElementById("pintxt");
