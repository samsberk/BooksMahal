<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CartManager.aspx.cs" Inherits="Admin_Block_CartManager" %>
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			...
			<div class="side-menu-box">
				...
				<div class="panel-body"><br />
					<h3 style="text-align:center;"><i class="fa fa-cog"></i> Cart Manager </h3><hr />
					<h4>Manage Cart :</h4>
					<div style="height:500px;width:100%;overflow:auto;">
						<table border="1" style="width:100%;">
							<tr><th>Manage</th><th>Cart ID</th><th>CID</th><th>PID</th><th>Quantity</th></tr>
