<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsletterMail.aspx.cs" Inherits="Admin_Block_NewsletterMail" %>
			...
			<div class="side-menu-box">
				...
				<div class="panel-body"><br />
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<h4>Send Mail to All Registered Customer <i class="fa fa-caret-down"></i></h4><hr />
							<label for="subjecttxt">Enter Subject :</label>
							<asp:TextBox runat="server" ID="subjecttxt" CssClass="form-control txt" placeholder="Subject"></asp:TextBox>
							<label for="bodytxt">Enter Mail :</label>
