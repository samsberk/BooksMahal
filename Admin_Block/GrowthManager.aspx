<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GrowthManager.aspx.cs" Inherits="Admin_Block_GrowthManager" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>BooksMahal | Growth Manager</title>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			...
			<div class="side-menu">
				...
				<a href="Administrator_Growth_Manager" class="click-on"><span class="glyphicon glyphicon-signal now-open" data-toggle="tooltip" data-placement="right" title="GROWTH MANAGER"></span></a>
			...
			<div class="side-menu-box">
				...
				<div class="panel-body"><br />
					<h3 style="text-align:center;"><i class="fa fa-cog"></i> Growth Manager </h3><hr/>
					<div class="row">
						<div class="col-sm-2"></div>
						<div class="col-sm-8">
							<h4>Monthly Growth (All) <i class="fa fa-caret-down"></i></h4><hr />
							<canvas id="myChart2"></canvas>
							<asp:Label runat="server" ID="alllbl"></asp:Label>
						</div>
						<div class="col-sm-2"></div>
					</div><br />
					<div class="row">
						<div class="col-sm-2"></div>
						<div class="col-sm-8">
							<h4>Monthly Growth (Delivered) <i class="fa fa-caret-down"></i></h4><hr />
							<canvas id="myChart3"></canvas>
							<asp:Label runat="server" ID="dellbl"></asp:Label>
						</div>
						<div class="col-sm-2"></div>
					</div><br />
					<div class="row">
						<div class="col-sm-2"></div>
						<div class="col-sm-8">
							<h4>Monthly Growth (Canceled) <i class="fa fa-caret-down"></i></h4><hr />
							<canvas id="myChart4"></canvas>
							<asp:Label runat="server" ID="canlbl"></asp:Label>
						</div>
						<div class="col-sm-2"></div>
					</div><hr /><br />
				</div>
