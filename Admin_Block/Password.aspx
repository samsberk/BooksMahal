<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Password.aspx.cs" Inherits="Admin_Block_Password" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>BooksMahal | Password Manager</title>
...
<body>
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			...
			<div class="side-menu">
				...
				<a href="Administrator_Password" class="click-on"><span class="glyphicon glyphicon-lock now-open" data-toggle="tooltip" data-placement="right" title="RESET PASSWORD"></span></a>
			...
			<div class="side-menu-box">
				...
				<div class="panel-body"><br />
					<h3 style="text-align:center;"><i class="fa fa-cog"></i> Password Manager</h3><hr />
					<div class="row">
						<div class="col-sm-3"></div>
						<div class="col-sm-6">
							<label for="passtxt">Choose Password :</label>
							<asp:TextBox runat="server" ID="passtxt" TextMode="Password" MaxLength="20" placeholder="Enter New Password" CssClass="form-control txt"></asp:TextBox>
							<label for="repasstxt">Re-enter Password :</label>
							<asp:TextBox runat="server" ID="repasstxt" TextMode="Password" MaxLength="20" placeholder="Re-enter New Password" CssClass="form-control txt"></asp:TextBox>
							<asp:Button runat="server" ID="passbtn" CssClass="btn btn-warning" Text="Reset Password" OnClick="passbtn_Click"/>
						</div>
						<div class="col-sm-3"></div>
					</div><hr /><br />
				</div>
	...
	<script type="text/javascript">
		...
		if ($("#informer").text() == "PasswordChanged") {
			$(".alert-box").show();
		}
		else if ($("#informer").text() == "PasswordNotChanged") {
			$(".alert-box").show();
		}
