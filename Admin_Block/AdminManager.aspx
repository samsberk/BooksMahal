<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminManager.aspx.cs" Inherits="Admin_Block_AdminManager" %>
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			...
			<div class="side-menu-box">
				...
				<div class="panel-body"><br />
					<h3 style="text-align:center;"><i class="fa fa-cog"></i> Administrator Manager</h3><hr />
					<div class="row">
						<div class="col-sm-3"></div>
						<div class="col-sm-6">
							<h4>Administrator Generator</h4><hr />
							<label for="aidtxt">Email ID :</label>
							<asp:TextBox runat="server" ID="aidtxt" MaxLength="45" TextMode="Email" placeholder="Email ID" CssClass="form-control txt" style="text-transform:lowercase;"></asp:TextBox>
							<label for="mobiletxt">Mobile ( Only 10 Digit ) :</label>
							<asp:TextBox runat="server" ID="mobiletxt" TextMode="Number" placeholder="Mobile Number 10 Digit" CssClass="form-control txt"></asp:TextBox>
							<label for="nametxt">Name :</label>
							<asp:TextBox runat="server" ID="nametxt" MaxLength="45" placeholder="Name" CssClass="form-control txt"></asp:TextBox>
							<div class="alert alert-info">NOTE : Password will send to given Email ID</div>
							<asp:Button runat="server" ID="genbtn" CssClass="btn btn-success" Text="Generate Admin ID" OnClick="genbtn_Click" />
						</div>
						<div class="col-sm-3"></div>
					</div><br /><br />
					<h4>View Administrator ID</h4><hr />
					<div style="height:500px;width:100%;overflow:auto;">
						<table border="1" style="width:100%;">
							<tr><th>Delete</th><th>Admin ID</th><th>Mobile</th><th>Name</th><th>Reg. Date</th></tr>
							<asp:PlaceHolder runat="server" ID="adminph"></asp:PlaceHolder>
						</table>
					</div>
				</div>
			</div>
