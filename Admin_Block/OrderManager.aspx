<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderManager.aspx.cs" Inherits="Admin_Block_OrderManager" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>BooksMahal | Order Manager</title>
	...
	<style type="text/css">
		.new-box, .delivered-box,.accepted-box, .canceled-box{
			display:none;
		}
		.txt {
			margin-bottom: 10px;
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			...
			<div class="side-menu">
				...
				<a href="Administrator_Order_Manager" class="click-on"><span class="glyphicon glyphicon-shopping-cart now-open" data-toggle="tooltip" data-placement="right" title="ORDER MANAGER"></span></a>
			...
			<div class="side-menu-box">
				...
				<div class="panel-body"><br />
					<h3 style="text-align:center;"><i class="fa fa-cog"></i> Order Manager </h3><hr />
					<button type="button" id="new" class="btn btn-default btn-xs">New</button>
					<button type="button" id="accepted" class="btn btn-default btn-xs">Accepted</button>
					<button type="button" id="delivered" class="btn btn-default btn-xs">Delivered</button>
					<button type="button" id="canceled" class="btn btn-default btn-xs">Canceled</button><hr />
					<div class="new-box">
						<h4>New Orders <i class="fa fa-caret-down"></i></h4><br />
						<div style="height:600px;width:100%;overflow:auto;">
							<table border="1" style="width:100%;">
								<tr><th>Sr.No.</th><th>Order ID</th><th>Email ID</th><th>Customer Name</th><th>Mobile</th><th>Address</th></tr>
								<asp:PlaceHolder runat="server" ID="neworderph"></asp:PlaceHolder>
							</table>
						</div>
					</div>
					<div class="accepted-box">
						<h4>Accepted Orders <i class="fa fa-caret-down"></i></h4><br />
						<div style="height:600px;width:100%;overflow:auto;">
							<table border="1" style="width:100%;">
								<tr><th>Sr.No.</th><th>Order ID</th><th>Email ID</th><th>Customer Name</th><th>Mobile</th><th>Address</th></tr>
								<asp:PlaceHolder runat="server" ID="accptorderph"></asp:PlaceHolder>
							</table>
						</div>
					</div>
					<div class="delivered-box">
						<h4>Delivered Orders <i class="fa fa-caret-down"></i></h4><br />
						<div style="height:600px;width:100%;overflow:auto;">
							<table border="1" style="width:100%;">
								<tr><th>Sr.No.</th><th>Order ID</th><th>Email ID</th><th>Customer Name</th><th>Mobile</th><th>Address</th></tr>
								<asp:PlaceHolder runat="server" ID="delorderph"></asp:PlaceHolder>
							</table>
						</div>
					</div>
					<div class="canceled-box">
						<h4>Canceled Orders <i class="fa fa-caret-down"></i></h4><br />
						<div style="height:600px;width:100%;overflow:auto;">
							<table border="1" style="width:100%;">
								<tr><th>Sr.No.</th><th>Order ID</th><th>Email ID</th><th>Customer Name</th><th>Mobile</th><th>Address</th></tr>
								<asp:PlaceHolder runat="server" ID="canorderph"></asp:PlaceHolder>
							</table>
						</div>
					</div>
				</div>
