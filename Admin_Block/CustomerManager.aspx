<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerManager.aspx.cs" Inherits="Admin_Block_CustomerManager" %>
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			...
			<div class="side-menu-box">
				...
				<div class="panel-body"><br />
					<h3 style="text-align:center;"><i class="fa fa-cog"></i> Customer Manager </h3><hr />
					<div style="height:500px;width:100%;overflow:auto;">
						<h4>View Customer Details :</h4>
						<table border="1" style="width:100%;">
							<tr><th>Sr.No</th><th>Customer ID</th><th>Name</th><th>Mobile</th></tr>
							<asp:PlaceHolder runat="server" ID="userph"></asp:PlaceHolder>
						</table>
					</div><hr /><br />
				</div>
			</div>
