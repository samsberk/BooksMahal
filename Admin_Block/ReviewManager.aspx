<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReviewManager.aspx.cs" Inherits="Admin_Block_ReviewManager" %>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			...
			<div class="side-menu">
				...
				<a href="Administrator_Review_Manager" class="click-on"><span class="glyphicon glyphicon-comment now-open" data-toggle="tooltip" data-placement="right" title="REVIEW MANAGER"></span></a>
			...
			<div class="side-menu-box">
				...
				<div class="panel-body"><br />
					<h3 style="text-align:center;"><i class=" fa fa-cog"></i> Review Manager</h3><hr />
					<h4><i class="fa fa-comments"></i> Show Product Review For :</h4><br />
