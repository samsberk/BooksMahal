...
<head runat="server">
	<title>BooksMahal | Order Placed Confirmation </title>
	...
	<style type="text/css">
		#informer, #showbtn, #signinbtn, #signoutbtn{
			display:none;
		}
		label{
			font-size:14px;
	...
	<div style="min-height:80vh;padding:50px 0px;background:url('images/bm1.jpg') center no-repeat;">
		<div class="col-sm-4" style="margin-left:50vw;transform:translateX(-50%);">
			<div id="signupbox" class="box-center text-center">
				<h4 style="color:green;">Order Placed Successfully</h4><hr />
				<b style="color:magenta;">Thank You for being here.</b><br />
				Your Order Number : <asp:Label runat="server" ID="ordernolbl" Text="Unauthorize"></asp:Label><br />
				Check out your given E-Mail ID, details of order was send in it.<br /><br />
				<a href="Shop" class="btn btn-success">Continue to Shop</a>
			</div>
		</div>
	</div>
	<!-- about -->
