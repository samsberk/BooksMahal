...
<body>
				...
				<div class="carousel-inner" role="listbox">
					<div class="carousel-item active">
						<div class="carousel-caption text-center">
							...
							<a href="Shop?for=Engg. Quantums" class="btn btn-sm animated-button gibson-three mt-4 click-on">Shop Now</a>
						</div>
					</div>
					<div class="carousel-item item2">
						<div class="carousel-caption text-center">
							<h3>Departmental Books
								<span>Get upto 30% off</span>
							</h3>
							<a href="Shop" class="btn btn-sm animated-button gibson-three mt-4 click-on">Shop Now</a>

						</div>
					</div>
					<div class="carousel-item item3">
						<div class="carousel-caption text-center">
							<h3>Competative Books
	...
	<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
		<div class="container-fluid">
			<div class="inner-sec-shop px-lg-4 px-3">
				...
				<div class="row">
					<asp:PlaceHolder runat="server" ID="newproph"></asp:PlaceHolder>
				</div>
				<div class="row">
					<div class="col-sm-4"></div>
					<div class="col-sm-4"><br />
						<a href="Shop" class="btn btn-warning btn-block">View More Items</a>
					</div>
					<div class="col-sm-4"></div>
				</div>
				<!--//row-->
				...
				<!--//meddle-->
				<!--/slide--><hr />
				<h3 class="tittle-w3layouts my-lg-4 my-4">Featured Books </h3>
				...
				<div class="row galsses-grids pt-lg-5 pt-3">
					<div class="col-lg-6 galsses-grid-left">
						<figure class="effect-lexi">
							<img src="images/bm4.jpg" alt="" class="img-fluid" />
							<figcaption>
								<h3>Reader's
									<span>Pick</span>
								</h3>
								<p>Go digital with booksmahal...!</p>
							</figcaption>
						</figure>
					</div>
					<div class="col-lg-6 galsses-grid-left">
						<figure class="effect-lexi">
							<img src="images/bm3.jpg" alt="" class="img-fluid" />
							<figcaption>
								<h3>Reader's
									<span>Choice</span>
								</h3>
								<p>Search your books Now...!</p>
							</figcaption>
						</figure>
					</div>
				</div>
	...
	<!-- Modal -->
	<!-- Modal -->
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-hidden="true" style="z-index:999999999;">
			...
			<div class="modal-content">
				...
				<div class="modal-body text-center p-5 mx-auto mw-100">
					<div class="login newsletter">
						...
						Check it out later.<br /><br />
						You can order via Whatsapp : 9720410274
	...
	<script type="text/javascript">
		...
		if ($("#informer").text() == "AlreadyAddedThisProduct") {
			$(".alert-box").show();
		}
