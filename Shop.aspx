...
<head runat="server">
<title>BooksMahal | Shop for Books </title>
					...
					<div class="row">
						...
						<div class="side-bar col-lg-3">
							<div class="search-hotel">
								<h3 class="agileits-sear-head">Upcomings...</h3>
						...
						<div class="left-ads-display col-lg-12">
							<div class="wrapper_top_shop">
								...
								<div class="row">
									<asp:PlaceHolder runat="server" ID="catwiseph"></asp:PlaceHolder>
								</div>
							</div>
						</div>
					</div>
					
						<!--/Slide footer owl carousel -->
